...
help:
	...
	@echo "  reset-test-db - Reset test database (requires CONF_FILE)"
	...
	@echo "  RESET_DB=true make test-pgsql       # Reset DB before running tests"
	@echo "  RESET_DB=true make test-mysql       # Reset MySQL DB and run tests"
	@echo "  make reset-test-db CONF_FILE=pgsql.conf  # Manually reset database"
